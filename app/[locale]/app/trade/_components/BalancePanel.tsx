...
import { coinToMoney } from "@/app/utils/helperFunctions";
  ...
  return (
    <div className="d-flex flex-column gap-4">
      <div className="p-4 text-center d-flex justify-content-center gap-3 flex-column">
        ...
        <h3 className="fw-bold">  ${totalBalance.toLocaleString(undefined, { minimumFractionDigits: 2 })}</h3>
          ...
          >
            ...
            <div className="text-end">
              <span className="fw-bold body2">
                ...
                <span>$</span>
                {(b.free &&
                  coinToMoney(Number(b.free), marketData, b.asset)?.toFixed(
                    2
                  )) ??
                  "1.500"}
              </span>
